        ...
        <header className="h-16 bg-[var(--card-bg)] backdrop-blur-md border-b border-[var(--border-color)] flex items-center justify-between px-8 sticky top-0 z-10 transition-colors">
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-white ring-2 ring-slate-800 shadow-lg">
                        {user?.profilePicture ? (
                ...
                <button
                    ...
                    className="ml-4 p-2 text-slate-400 hover:text-red-400 transition-colors tooltip"
                    title="Logout"
                >
